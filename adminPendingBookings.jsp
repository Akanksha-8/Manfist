...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4" style="margin-top: 55px;">
  <h4 class="border-bottom border-gray pb-2 mb-0">All Pending Bookings</h4>
   <div class="row p-3 table-responsive-md">
            <table class="table table-light" style="overflow-y:scroll;">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                  	<a href="AdminConfirmBooking?BookingID=<c:out value="${booking.id}" />" class="btn btn-success" title="Confirm Booking"><i class="fas fa-calendar-alt"></i></a> &nbsp;
                  </td>
                </tr>
              </c:forEach>
              </tbody>
