...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4" style="margin-top: 55px;">
  <h4 class="border-bottom border-gray pb-2 mb-0">All Confirmed Bookings</h4>
            ...
            <table class="table table-light">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                   	<a href="AdminCancelBooking?CancelID=<c:out value="${booking.id}" />" class="btn btn-danger" title="Cancel"><i class="fas fa-window-close"></i></a></td>
                </tr>
              </c:forEach>
              </tbody>
            </table>
